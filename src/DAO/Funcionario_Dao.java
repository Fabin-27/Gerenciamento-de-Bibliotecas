...
public class Funcionario_Dao {
	...
	public static boolean inserirFuncionario(String nome, String cpf, String cargo, double salario, String email, String telefone, String dataContratacao) {
	...
	public static void listarFuncionarios() {
	    ...
	    try (Connection conn = DB.getConnection();
	        ...
	        System.out.printf("%-5s %-20s %-15s %-20s %-10s %-30s %-15s %-15s%n", 
	                          "ID", "Nome", "CPF", "Cargo", "Salário", "Email", "Telefone", "Data de Contratação");
	        System.out.println("-----------------------------------------------------------------------------------------------------------------------------------------");

	        while (rs.next()) {
	            System.out.printf("%-5d %-20s %-15s %-20s %-10.2f %-30s %-15s %-15s%n",
	                              rs.getInt("id"),
	                              rs.getString("nome"),
	                              rs.getString("cpf"),
	                              rs.getString("cargo"),
	...
	public static boolean editarFuncionario(int id, String nome, String cpf, String cargo, String dataContratacao, String email, String telefone, double salario) {
	...
	public static boolean inserirLogin(String email, String senha) {
